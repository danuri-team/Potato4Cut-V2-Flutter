...
import 'package:potato_4cut_v2/features/sign_up/widgets/sign_up_text_form_field.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SubmitButton(
                onTap: () => Throttle.run(() => AppNavigation.goSignUpStep2(context)),
                width: 343.w,
                text: '확인',
                isActivate: (nickname != null && nickname.isNotEmpty),
              ),
            ],
          ),
        ),
